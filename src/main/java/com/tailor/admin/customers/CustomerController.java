...
public class CustomerController {
    ...
    public ResponseEntity<Response> getCustomerByCustomerName(@PathVariable String customerName){
        return this.customerService.getCustomerByCustomerName(customerName);
    }
}
